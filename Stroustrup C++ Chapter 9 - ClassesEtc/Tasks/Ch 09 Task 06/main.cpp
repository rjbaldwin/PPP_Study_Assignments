...
int main()
{
    ...
    RobsLibrary::Book deadZone(deadISBN, "The Dead Zone", "Stephen King", 1979);


    RobsLibrary::ISBN hot(1, 452, 222, 'b');
    string hotISBN = toString(hot);
    RobsLibrary::Book hotZone(hotISBN, "The Hot Zone", "Richard Preston", 1994);


    RobsLibrary::ISBN aud(222, 42454, 1771456, 'c');
    string audISBN = toString(aud);
    RobsLibrary::Book audio(audISBN, "The Audio Expert", "Ethan Winer", 2008);
